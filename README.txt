...
For Assignment 3, the first thing that needs to be checked is that all the files (extract_words.py, words.txt, TheThreeMuskateers.txt, and group3_assignment3_pde) are in the same folder (group_18_assignment3).
